 ...
 * Implementation of the Statistics set class into one class to make it more
 * manageable in classes using statistics
 **/
public class RunTimeStatistics {
	...
	public void addAllocationTime(long time) {
		...
		try {
			...
			Logger.getLogger(RunTimeStatistics.class.getName()).log(
