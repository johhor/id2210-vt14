...
public class QueueLengthComparer {
    ...
    public int queueCompare(PeerDescriptor o1, PeerDescriptor o2) {
        if (o1.getAvailableResources().getQueueLength() == o2.getAvailableResources().getQueueLength()){
        	return 0;
        } else if (o1.getAvailableResources().getQueueLength() < self.getAvailableResources().getQueueLength() && o2.getAvailableResources().getQueueLength() >= self.getAvailableResources().getQueueLength()) {
        	return -1;
