...
public class ComparatorByCPU extends QueueLengthComparer implements Comparator<PeerDescriptor> {
    ...
    public int compare(PeerDescriptor o1, PeerDescriptor o2) {
        if (o1.getAvailableResources().getNumFreeCpus() == o2.getAvailableResources().getNumFreeCpus() && o1.getAvailableResources().getQueueLength() == o2.getAvailableResources().getQueueLength() )
            return 0;
